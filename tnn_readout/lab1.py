...
for epochs in range(num_epochs):
    # print("Epoch {} of {}".format(epochs, num_epochs))
    start = time.time()
    jj = 0
    for data, target in MNIST_trainLoader:
        print("Pair {} of {}".format(jj, len(MNIST_trainLoader)))
        jj = jj + 1
        for i in range(len(data)):
            ...
            # if (i % 100 == 0):
            #     print("Trained {} of {} inputs.".format(i, len(data)))
    end = time.time()
...
print("Purity: ", (pred/covg_cnt).item())
print("Coverage: ", (covg_cnt/count).item())

print("SUMMARY")
print("rf_size,num_neurons,startposition,threshold,timesteps,purity,coverage")
print("{},{},{},{},{},{:.3f},{:.3f}".format(\
    rf_size, num_neurons, startposition, threshold, \
    timesteps,float((pred/covg_cnt).item()),float((covg_cnt/count).item())))
