...
seqMnistSimConcat(examples, dataloader, network, time, spikes,
...
training_pairs = seqMnistSimConcat(examples, dataloader, network, time, spikes,
...
test_pairs = seqMnistSimConcat(examples, dataloader, network, time, spikes,
